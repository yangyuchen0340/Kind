fprintf('****************************************\n')
fprintf('Test on UKBench\n')
fprintf('****************************************\n')

diary('result_UKBench.txt');
diary on;
...
% data setting
K_cluster = (10:40:610); ntest =  numel(K_cluster);
...
if plot_figure == 1
    ...
    title('A: UKBench [n,d,k] = [4k,2048,k]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('D: UKBench [n,d,k] = [4k,2048,k]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('B: UKBench [n,d,k] = [4k,2048,k]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('C: UKBench [n,d,k] = [4k,2048,k]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('E: UKBench [n,d,k] = [4k,2048,k]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('F: UKBench [n,d,k] = [4k,2048,k]','FontSize',13)
    
end

% save result_UKBench.mat K_cluster T FM FI AC NMI AMI
% save result_UKBench_all.mat