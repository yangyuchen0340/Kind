fprintf('****************************************\n')
fprintf('Test on TDT2\n')
fprintf('****************************************\n')

addpath real_data
addpath utility 
diary('result_TDT2.txt');
diary on;

%% load data
filename = {'TDT2all'};
load ( strcat(filename{1},'.mat'))
...
% data setting
K_cluster = (30:10:80); ntest =  numel(K_cluster);
...
if plot_figure == 1
    ...
    title('A: TDT2 [n,d,k] = [10212,36771,96]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('D: TDT2 [n,d,k] = [10212,36771,96]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('B: TDT2 [n,d,k] = [10212,36771,96]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('C: TDT2 [n,d,k] = [10212,36771,96]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('E: TDT2 [n,d,k] = [10212,36771,96]','FontSize',13)
    ...
    set(h,'linewidth',2,'MarkerSize',8); grid on; drawnow, shg
    title('F: TDT2 [n,d,k] = [10212,36771,96]','FontSize',13)
end
save result_TDT2.mat K_cluster T FM FI AC NMI AMI